...
# ==============================
ETHERTYPE = 0x88B5
HEADER_FMT = "!6s6sH B H H H H"  # MAC dst, MAC src, EtherType, type, transfer_id, fragment_no, total_frags, payload_len
